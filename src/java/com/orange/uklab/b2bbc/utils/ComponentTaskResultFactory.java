...
public class ComponentTaskResultFactory
{
            ...
            throws B2BException
    {
        if (optionalMessageType != null)
        {
            if (!(optionalMessageType.equals(ComponentTaskResultFactory.MESSAGE_TYPE_ERROR) || optionalMessageType.equals(ComponentTaskResultFactory.MESSAGE_TYPE_INFO) || optionalMessageType.equals(ComponentTaskResultFactory.MESSAGE_TYPE_WARNING)))
            {
            ...
            throws B2BException
    {
        if (taskResult != null)
        {
            if (!(taskResult.equals(ComponentTaskResultFactory.TASK_RESULT_FAILED) || taskResult.equals(ComponentTaskResultFactory.TASK_RESULT_SUCCESS)))
            {
